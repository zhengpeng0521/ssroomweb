...
const namespace = 'hqSupercardGoodsModel';
...
function hqSupercardGoods({ dispatch, hqSupercardGoodsModel, }) {
  ...
  function sureStockClickFn(){
    ...
    dispatch({
      type: 'hqSupercardGoodsModel/setPlatGoodsAppoint',
      payload: {
        goodsId,
        vipCardId,
        dateAppoint
...
//新版库存变量改变
    ...
    if (modalType == '1' || modalType == '4') {
      ...
      dispatch({
        type: 'hqSupercardGoodsModel/updateIgnoreField',
        payload: {
          ...val,
        },
      });
  ...
  function showcancelStockSettingFn(record){
    ...
    dispatch({
      type: 'hqSupercardGoodsModel/getPlatGoodsAppoint',
      payload: {
    ...
    search: {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'select',
          placeholder: '运营状态',
          options: [{ label: '运营中', key: '0', }, { label: '废弃', key: '1', },],
          initialValue:'0'
        },
        {
          key: 'vipCardId',
