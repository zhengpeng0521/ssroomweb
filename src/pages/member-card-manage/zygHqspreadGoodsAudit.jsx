...
const namespace = 'zygHqspreadGoodsAuditModel';
import React from 'react';
import { connect, } from 'dva';
import { Popover, Input, Icon,Button, Modal  } from 'antd';
...
function zygHqspreadGoodsAudit({ dispatch, zygHqspreadGoodsAuditModel, }) {
  const {
    ...
    qrUrl, //二维码图片
    path, //二维码地址
  } = zygHqspreadGoodsAuditModel;

  /*改变表格显示项*/
  function changeColumns(newColumns) {
    dispatch({
      type: 'zygHqspreadGoodsAuditModel/updateState',
      payload: {
  ...
  function pageOnChange(pageIndex, pageSize) {
    dispatch({
      type: 'zygHqspreadGoodsAuditModel/pageChange',
      payload: {
        pageIndex,
        pageSize,
      },
  ...
  function addAndEditGoods(type, record) {
    dispatch({
      type: 'zygHqspreadGoodsAuditModel/queryPlatGoodsAdditionalInfo',
      payload: {},
    });
    if (type == 'audit') {
      dispatch({
        type: 'zygHqspreadGoodsAuditModel/getPlatGoods',
        payload: {
          id: record.spuId,
        },
      });
  ...
  function confirmAgreeAlert() {
    dispatch({
      type: 'zygHqspreadGoodsAuditModel/auditGoods',
      payload: {
...
function mapStateToProps({ zygHqspreadGoodsAuditModel, }) {
  return { zygHqspreadGoodsAuditModel, };
}

export default connect(mapStateToProps)(zygHqspreadGoodsAudit);
