...
import { queryAsyncList, downloadTemplate } from '../../services/report/ZygReportOvStat'
	...
	subscriptions: {
		setup({ dispatch, history, }) {
			history.listen(({ pathname, query, }) => {
				if (pathname == '/zyg_report_ov_stat') {
					dispatch({
						type: 'queryAsyncList',
						payload: {
							pageIndex: 0,
